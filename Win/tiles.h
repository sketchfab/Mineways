...
static struct {
    ...
    { 11, 2, L"crafting_table_top", L"workbench_top", SWATCH_REPEAT_ALL },
    ...
    { 11, 3, L"crafting_table_side", L"workbench_side", SWATCH_REPEAT_ALL },
    { 12, 3, L"crafting_table_front", L"workbench_front", SWATCH_REPEAT_ALL },
    ...
    { 9, 9, L"log_jungle", L"tree_jungle", SWATCH_REPEAT_ALL },
    ...
    { 5, 11, L"log_acacia", L"tree_acacia", 0x0 },	// ADD-IN 1.7.2
    ...
    { 15, 13, L"water_still", L"water", SWATCH_REPEAT_ALL },
    ...
    { 13, 19, L"log_acacia_top", L"tree_top", SWATCH_REPEAT_ALL },	// ADD-IN 1.7.2
    { 14, 19, L"log_big_oak", L"tree_top", SWATCH_REPEAT_ALL },	// ADD-IN 1.7.2
    { 15, 19, L"log_big_oak_top", L"tree_top", SWATCH_REPEAT_ALL },	// ADD-IN 1.7.2
    ...
    { 15, 25, L"water_overlay", L"water", SWATCH_REPEAT_ALL },    // 1.9 - water looks like this through glass.
    ...
    { 8, 26, L"water_flow", L"water", SWATCH_CLAMP_ALL },	// special: double-wide
